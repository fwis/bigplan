class World {
    ...
    _buildDenseGrassMesh() {
        ...
        var denseGrassMesh = BABYLON.Mesh.MergeMeshes(items, true, false, null, false, true);
        ...
        return denseGrassMesh;
         ...
         _buildFlowerGrassMesh() {
            ...
            for (var i = 0; i < flowerCount; i++) {
                ...
                var flowerPetal = BABYLON.MeshBuilder.CreateSphere("flowerPetal" + i, { diameter: 0.4 }, that.scene);
                flowerPetal.material = new BABYLON.StandardMaterial("flowerMaterial", that.scene);
            ...
            var flowerGrassMesh = BABYLON.Mesh.MergeMeshes(items, true, false, null, false, true);
    ...
    LoadGrassModel(grassURL) {
        ...
        this.grassTemplate2 = this._buildDenseGrassMesh();
    ...
    CreateDenseGrass(x, z, rotation) {
        var denseGrassMesh = this._buildDenseGrassMesh();
        denseGrassMesh.name = "grass" + this.grassIndex;
        this.grassIndex++;
...
CreateFlowerGrass(x, z, rotation) {
    var flowerGrassMesh = this._buildFlowerGrassMesh();
    flowerGrassMesh.name = "flowerGrass" + this.grassIndex;
    this.grassIndex++;
